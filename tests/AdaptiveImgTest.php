...
class AdaptiveImgTest extends TestCase
{
    /**
     * @throws Exception
    ...
    public function testTypeX()
    {
        ...
        $generatedImg2 = AdaptiveImg::adapt('<img src="test.jpg" width="170" alt="">');
        $generatedImg3 = AdaptiveImg::adapt('<img src="test.jpg" alt="">', 170);
    ...
    public function testTypeW()
    {
        ...
        $generatedImg = AdaptiveImg::adapt(
            '<img
                src="test.jpg"
        ...
        $generatedImg2 = $generatedImg2->typeW(
            '(max-width: 992px) calc(50vw), (max-width: 1199px) 512px, (max-width: 1279px) 25vw, 320px',
            [160, 188, 240, 284, 320, 334, 384, 512],
            [
                'class'     => 'class-1 class-2',
                'style'     => 'border: 1px solid black',
                'data-name' => 'image',
        ...
        $generatedImg4 = $generatedImg4->typeW(
            '(max-width: 992px) calc(50vw), (max-width: 1199px) 512px, (max-width: 1279px) 25vw, 320px',
            [],
            [
                'class'     => 'class-1 class-2',
