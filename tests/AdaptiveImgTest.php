...
class AdaptiveImgTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $expected = '<img src="test@170x-.jpg" alt="" srcset="test@170x-.jpg 1.0x, test@255x-.jpg 1.5x, test@340x-.jpg 2.0x, test@510x-.jpg 3.0x">';
        $expected2 = '<img src="test@170x-.jpg" alt="" width="170" srcset="test@170x-.jpg 1.0x, test@255x-.jpg 1.5x, test@340x-.jpg 2.0x, test@510x-.jpg 3.0x">';
    ...
    public function testTypeW()
    {
        ...
        $this->assertEquals($expected, $generatedImg);
        $this->assertEquals($expected, $generatedImg2);
    }
}